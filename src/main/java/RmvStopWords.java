 ...
 */
public class RmvStopWords {

    public ArrayList<String> rmvStopWords(ArrayList<String> liste){

        ArrayList<String> stpWor = new ArrayList<>();
          /*      stpWor: {"a","about", "above", "above", "across", "after", "afterwards", "again", "against", "all", "almost",
                ...
                "hereby", "herein", "hereupon", "hers", "herself", "him", "himself", "his", "how", "however", "hundred", "ie", "if", "in",
                ...
                "much", "must", "my", "myself", "name", "namely", "neither", "never", "nevertheless", "next", "nine", "no", "nobody", "none",
